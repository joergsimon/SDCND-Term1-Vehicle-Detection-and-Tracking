...
After experimenting with that two python scripts were created, one to train the classifier called `train_cld.py` who saves scaler and clf file as pickle and another called `detect_and_track.py`
